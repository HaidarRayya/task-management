...
use App\Http\Requests\Task\ManagerTaskRequest;
...
class TaskController extends Controller
{
     ...
     * @return response  of the status of operation : task 
     */
    public function allDeletedTasks()
    {
    ...
    /**
     * change a manager a specified task
     * @param Task $task
     * @param ManagerTaskRequest $request
     * @return response  of the status of operation : task and message 
     */
    public function changeManageTask(Task $task, ManagerTaskRequest $request)
    {
        $task = $this->taskService->updateTask(['manager_id' => $request->manager_id], $task);
        return response()->json([
            'status' => 'success',
            'data' => [
                'task' =>  $task
